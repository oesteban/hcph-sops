...
for pi0 in pi0_values:
    ...
    results_multi_pi0[pi0] = run_simulation(true_pi0=pi0, true_lambda=2.0, true_mu=3.0, true_sigma=0.5, display_plots=False, progressbar=False, random_seed=None, repeat_fit=30)
