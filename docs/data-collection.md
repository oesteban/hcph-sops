...
- [ ] Indicate the participant to shave their chest, indicating where the ECG electrodes will be placed. The ECG electrodes MUST directly contact the skin.
- [ ] Confirm clothing:
...
- [ ] Connect the coaxial cable to the CO<sub>2</sub> output in the back of the GA. Connect the other end (RJ-45/Ethernet) into one of the channels of the AMI100D BIOPAC module. [I'M NOT SURE ABOUT THAT CONNECTION]
    ![gaz-analyser-front](./assets/images/gaz-analyser-back.jpg "Gas Analyzer front")
- [ ] Turn the GA on using the on/off switch. [ADD PHOTO WITH CONNECTED CABLE]
